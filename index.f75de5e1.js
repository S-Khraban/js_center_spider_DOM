function initCenterSpider() {
    ...
    if (wallComputedPos === "static") wall.style.position = "relative";
    ...
    if (spider.complete) place();
    else spider.addEventListener("load", place, {
        once: true
    });
    window.addEventListener("resize", place);
}
if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", initCenterSpider, {
    once: true
});
else initCenterSpider();
